...
declare module 'fullcalendar/ComponentFootprint' {
	export class Default {
	    ...
	    constructor(unzonedRange: any, isAllDay: any, technicianSchedule?: any);
...
declare module 'fullcalendar/TechnicianTableMixin' {
	import Mixin from 'fullcalendar/Mixin';
	export interface TechnicianTableInterface {
	    ...
	    renderBgTrHtml(row: any): any;
	    bookendCells(trEl: any): any;
	    getCellTechnician(row: any, col: any): any;
	    getCellRange(row: any, col: any): any;
	    sliceRangeByDay(unzonedRange: any): any;
	    sliceRangeByRow(unzonedRange: any): any;
	    renderIntroHtml(): any;
	}
	export class Default extends Mixin implements TechnicianTableInterface {
	    breakOnWeeks: boolean;
	    schedules: any;
	    dayIndices: any;
	    techniciansPerRow: any;
	    ...
	    getCellTechnicianIndex(row: any, col: any): any;
	    getColDayIndex(col: any): any;
	    getDateDayIndex(date: any): number;
	    computeColHeadFormat(): any;
	    sliceRangeByRow(unzonedRange: any): any[];
	    sliceRangeByDay(unzonedRange: any): any[];
	    renderHeadHtml(): string;
	    ...
	    renderHeadTrHtml(): string;
	    renderHeadDateCellsHtml(): string;
	    renderHeadTechnicianCellHtml(technicianNickName: any, colspan: any, otherAttrs: any): string;
	    renderBgTrHtml(row: any): string;
	    renderBgIntroHtml(row: any): void;
	    renderBgCellsHtml(row: any): string;
	    renderBgCellHtml(date: any, otherAttrs: any): string;
...
declare module 'fullcalendar/TechnicianTimeGrid' {
	import * as moment from 'moment';
	import InteractiveDateComponent from 'fullcalendar/InteractiveDateComponent';
	import { TechnicianTableInterface } from 'fullcalendar/TechnicianTableMixin';
	import ComponentFootprint from 'fullcalendar/ComponentFootprint';
	export class Default extends InteractiveDateComponent {
	    ...
	    renderBgTrHtml: TechnicianTableInterface['renderBgTrHtml'];
	    bookendCells: TechnicianTableInterface['bookendCells'];
	    getCellTechnician: TechnicianTableInterface['getCellTechnician'];
	    view: any;
	    helperRenderer: any;
	    dayRanges: any;
	    slotDuration: any;
	    ...
	    computeSnapTime(snapIndex: any, technicianSchedule: any): moment.Moment;
	    getHitEl(hit: any): any;
	    renderDrag(eventFootprints: any, seg: any, isTouch: any): boolean;
	    unrenderDrag(): void;
	    renderEventResize(eventFootprints: any, seg: any, isTouch: any): void;
...
declare module 'fullcalendar/src/exports' {
	...
	export { default as TechnicianTableMixin } from 'fullcalendar/TechnicianTableMixin';
